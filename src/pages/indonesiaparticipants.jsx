...
function IndoensiaParticipants() {
  ...
  const generatePaymentLink = async () => {
    if (
      selectedCategory !== "IYGO Online Competition" &&
      selectedCategory !== "IYGO Offline Competition" 
    ) {
      alert(
  ...
  useEffect(() => {
    if (selectedCategory === "IYGO Online Competition") {
      setPrice("300000");
    } else if (selectedCategory === "IYGO Offline Competition") {
      setPrice("1150000");
    } else {
      setPrice("");
    }
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbyMEubJx3qRCKBWVDVWFJnRc5I_HT9OFVk_i7lfca5u2QM_sMGApImplkG80Dg35W-k4w/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br></br>
            <h4>
              HALLO PESERTA IYGO 2024, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="IYGO Online Competition">
                      Kompetisi Online
                    </option>
                    <option value="IYGO Offline Competition">
                      Kompetisi Offline
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi IYGO 2024
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
