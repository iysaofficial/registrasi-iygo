...
export default function Internationalparticipants() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbwwq1jgsxOlzuLIzc0dWpRk-PKyHYo-bsiUR6wtF9uclqn5PuvaivOrO0lONQe3k0r_Eg/exec";
      ...
      <section className="registration-section">
        <div class="container">
          <div class="content">
            ...
            <br />
            <h4>
              HELLO IYGO 2024 PARTICIPANTS, Please consider the following
              ...
              <div className="user-details">
                ...
                <div class="input-box">
                  <label for="INFORMATION_RESOURCES" class="form-label">
                    IYGO 2024 Competition Information Resources
                  </label>
                  <select
                    type="text"
